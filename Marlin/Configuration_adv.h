...
#define SENSORLESS_BACKOFF_MM  { 10, 10 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 0, 0, 4 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
