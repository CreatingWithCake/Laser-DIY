...
#define CUSTOM_MACHINE_NAME "Custom Elegoo Laser"
...
#ifdef IS_BMG
  #ifdef IS_2D
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 415, 415 }
  #else
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 415 }
  #endif
#else
  #ifdef IS_2D
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 95, 95 }
  #else
 ...
 */
#ifdef IS_2D
  #define DEFAULT_MAX_FEEDRATE          { 150, 150, 5, 70, 70 }
#else
